...
func TestCreateChannel(t *testing.T) {
	id, err := CreateChannel("Pussy", u.Id)
	if err != nil {
		t.Error(err.Error())
	}
	ch := Chat{Id: id}
...
func TestCheckUserInChatDelete(t *testing.T) {
	...
	res, err := CheckUserInChatDelete(u.Id, id)
	if err != nil {
		t.Error(err)
	}
	if res {
...
func TestGetChatType(t *testing.T) {
	id, err := CreateChat("Alice", u.Id)
	if err != nil {
		t.Error(err)
		return
	}
	CType, err := GetChatType(id)
	if err != nil {
		t.Error(err)
		return
	}
...
func TestCheckUserRightsInChat(t *testing.T) {
	...
	err = CheckUserRightsInChat(u.Id, id)
	if err != nil {
...
func TestDeleteUsersInChat(t *testing.T) {
	...
	err = DeleteUsersInChat(users, ChId, false)
	if err != nil {
		t.Error(err)
		return
	}
